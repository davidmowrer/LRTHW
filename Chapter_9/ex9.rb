...
# Prints out the text for the variable "days" on the next line.
print 'Here are the days:', days, "\n"
# Prints out the text string on the first line.
# Prints out the text for the variable "months" one per line
puts 'Here are the months:', months

# This Prints out the content of the text between the PARAGRAPH'S,
# is this a special string!
puts <<PARAGRAPH
