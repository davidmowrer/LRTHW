...
ten = 10
# created a variable x with the value of text including a variable inside the text
...
do_not = "don't"
# created a variable y with the value of text including two variables inside the text
