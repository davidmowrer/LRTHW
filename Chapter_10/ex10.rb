...
# Set the value of variable persian_cat to print a text string that's split up and printed on two lines.
...
# Set the value of variable fat_cat using MY_HEREDOC to print out a list of text items.
fat_cat = <<MY_HEREDOC
I'll do a list:
\t* Cat food
\t* Fishies
...
puts tabby_cat
# Prints out text string splitting it up on two different lines for variable persian_cat
puts persian_cat
# Prints out text string with backslashes before and after "a" for variable backslash_cat
puts backslash_cat
